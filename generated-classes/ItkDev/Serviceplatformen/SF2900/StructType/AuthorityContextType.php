...
class AuthorityContextType extends AbstractStructBase
{
     ...
     * @param string $municipalityCVR
     * @return \ItkDev\Serviceplatformen\SF2900\StructType\AuthorityContextType
     */
    public function setMunicipalityCVR(string $municipalityCVR): self
    {
        ...
        if (!is_null($municipalityCVR) && !preg_match('/[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]/', (string) $municipalityCVR)) {
