...
class JournalPostFlerRelationType extends NulFlerRelationType
{
     ...
     * @var \ItkDev\Serviceplatformen\SF1500\Person\StructType\OffentlighedUndtagetType|null
     */
    protected ?\ItkDev\Serviceplatformen\SF1500\Person\StructType\OffentlighedUndtagetType $OffentlighedUndtaget = null;
    /**
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\Person\StructType\OffentlighedUndtagetType $offentlighedUndtaget
     * @param string $tilhoersforholdKode
     */
    public function __construct(?string $journalPostIdentifikator = null, ?string $titelTekst = null, ?int $indeksIdentifikator = null, ?\ItkDev\Serviceplatformen\SF1500\Person\StructType\OffentlighedUndtagetType $offentlighedUndtaget = null, ?string $tilhoersforholdKode = null)
    {
        $this
     ...
     * @param string $journalPostIdentifikator
     * @return \ItkDev\Serviceplatformen\SF1500\Person\StructType\JournalPostFlerRelationType
     */
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\Person\StructType\OffentlighedUndtagetType|null
     */
    public function getOffentlighedUndtaget(): ?\ItkDev\Serviceplatformen\SF1500\Person\StructType\OffentlighedUndtagetType
    {
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\Person\StructType\JournalPostFlerRelationType
     */
    public function setOffentlighedUndtaget(?\ItkDev\Serviceplatformen\SF1500\Person\StructType\OffentlighedUndtagetType $offentlighedUndtaget = null): self
    {
     ...
     * @uses \ItkDev\Serviceplatformen\SF1500\Person\EnumType\TilhoersforholdKodeType::valueIsValid()
     * @uses \ItkDev\Serviceplatformen\SF1500\Person\EnumType\TilhoersforholdKodeType::getValidValues()
    ...
    public function setTilhoersforholdKode(?string $tilhoersforholdKode = null): self
    {
        ...
        if (!\ItkDev\Serviceplatformen\SF1500\Person\EnumType\TilhoersforholdKodeType::valueIsValid($tilhoersforholdKode)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \ItkDev\Serviceplatformen\SF1500\Person\EnumType\TilhoersforholdKodeType', is_array($tilhoersforholdKode) ? implode(', ', $tilhoersforholdKode) : var_export($tilhoersforholdKode, true), implode(', ', \ItkDev\Serviceplatformen\SF1500\Person\EnumType\TilhoersforholdKodeType::getValidValues())), __LINE__);
        }
