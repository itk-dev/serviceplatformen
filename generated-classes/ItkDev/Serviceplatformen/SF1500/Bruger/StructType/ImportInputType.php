 ...
 * - definition: urn:oio:sagdok:brugerimportinput:ADD:2.0.0 | urn:oio:sagdok:importinput:ADD:1.0.0
 * @subpackage Structs
 */
class ImportInputType extends AbstractStructBase
{
     ...
     * - content: bruger
     * - ref: bruger:Bruger
     * @var \ItkDev\Serviceplatformen\SF1500\Bruger\StructType\BrugerType|null
     */
    protected ?\ItkDev\Serviceplatformen\SF1500\Bruger\StructType\BrugerType $Bruger = null;
    /**
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\Bruger\StructType\BrugerType $bruger
     */
    public function __construct(?string $noteTekst = null, ?\ItkDev\Serviceplatformen\SF1500\Bruger\StructType\BrugerType $bruger = null)
    {
        $this
     ...
     * Set NoteTekst value
     * @param string $noteTekst
     * @return \ItkDev\Serviceplatformen\SF1500\Bruger\StructType\ImportInputType
     */
    ...
    /**
     * Get Bruger value
     * @return \ItkDev\Serviceplatformen\SF1500\Bruger\StructType\BrugerType|null
     */
    public function getBruger(): ?\ItkDev\Serviceplatformen\SF1500\Bruger\StructType\BrugerType
    {
        return $this->Bruger;
    }
    /**
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\Bruger\StructType\ImportInputType
     */
    public function setBruger(?\ItkDev\Serviceplatformen\SF1500\Bruger\StructType\BrugerType $bruger = null): self
    {
        $this->Bruger = $bruger;
