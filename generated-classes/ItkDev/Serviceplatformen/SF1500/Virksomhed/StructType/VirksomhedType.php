...
class VirksomhedType extends PartType
{
    ...
    public static function validateRegistreringForArrayConstraintFromSetRegistrering(?array $values = []): string
    {
        ...
        foreach ($values as $virksomhedTypeRegistreringItem) {
            ...
            if (!$virksomhedTypeRegistreringItem instanceof \ItkDev\Serviceplatformen\SF1500\Virksomhed\StructType\RegistreringType) {
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\Virksomhed\StructType\RegistreringType[] $registrering
     * @return \ItkDev\Serviceplatformen\SF1500\Virksomhed\StructType\VirksomhedType
     */
