...
/**
 * This class stands for OrganisationFunktionerOutputType StructType
 * Meta information extracted from the WSDL
 * - definition: urn:oio:sts:organisationfunktioner:ADD:2.0.0
 * @subpackage Structs
 */
class OrganisationFunktionerOutputType extends AbstractStructBase
{
    /**
     * The FiltreretOejebliksbillede
     * Meta information extracted from the WSDL
     * - content: urn:oio:sagdok:organisationfunktion:ADD:2.0.0
     * - maxOccurs: unbounded
     * - minOccurs: 0
    ...
    /**
     * Constructor method for OrganisationFunktionerOutputType
     * @uses OrganisationFunktionerOutputType::setFiltreretOejebliksbillede()
    ...
    public static function validateFiltreretOejebliksbilledeForArrayConstraintFromSetFiltreretOejebliksbillede(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $organisationFunktionerOutputTypeFiltreretOejebliksbilledeItem) {
            // validation for constraint: itemType
            if (!$organisationFunktionerOutputTypeFiltreretOejebliksbilledeItem instanceof \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\FiltreretOejebliksbilledeType) {
                $invalidValues[] = is_object($organisationFunktionerOutputTypeFiltreretOejebliksbilledeItem) ? get_class($organisationFunktionerOutputTypeFiltreretOejebliksbilledeItem) : sprintf('%s(%s)', gettype($organisationFunktionerOutputTypeFiltreretOejebliksbilledeItem), var_export($organisationFunktionerOutputTypeFiltreretOejebliksbilledeItem, true));
            }
        }
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\FiltreretOejebliksbilledeType[] $filtreretOejebliksbillede
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\OrganisationFunktionerOutputType
     */
