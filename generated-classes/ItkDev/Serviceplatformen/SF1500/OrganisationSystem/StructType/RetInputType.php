 ...
 * - definition: urn:oio:sagdok:organisationretinput:ADD:2.0.0 | urn:oio:sagdok:organisationenhedretinput:ADD:2.0.0 | urn:oio:sagdok:organisationfunktionretinput:ADD:2.0.0 | urn:oio:sts:adresseretinput:ADD:2.0.0 | urn:oio:sts:personretinput:ADD:2.0.0 |
 * urn:oio:sagdok:brugerretinput:ADD:2.0.0 | urn:oio:sagdok:interessefaellesskabretinput:ADD:2.0.0 | urn:oio:sagdok:itsystemretinput:ADD:2.0.0 | urn:oio:sts:myndighedretinput:ADD:2.0.0 | urn:oio:sts:virksomhedretinput:ADD:2.0.0 |
 * urn:oio:sagdok:retinput:ADD:1.0.0
 * @subpackage Structs
 */
class RetInputType extends AbstractStructBase
{
     ...
     * @param string $uUIDIdentifikator
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\RetInputType
     */
