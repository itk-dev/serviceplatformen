...
/**
 * This class stands for ItSystemerOutputType StructType
 * Meta information extracted from the WSDL
 * - definition: urn:oio:sts:itsystemer:ADD:2.0.0
 * @subpackage Structs
 */
class ItSystemerOutputType extends AbstractStructBase
{
    /**
     * The FiltreretOejebliksbillede
     * Meta information extracted from the WSDL
     * - content: urn:oio:sagdok:itsystem:ADD:2.0.0
     * - maxOccurs: unbounded
     * - minOccurs: 0
    ...
    /**
     * Constructor method for ItSystemerOutputType
     * @uses ItSystemerOutputType::setFiltreretOejebliksbillede()
    ...
    public static function validateFiltreretOejebliksbilledeForArrayConstraintFromSetFiltreretOejebliksbillede(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $itSystemerOutputTypeFiltreretOejebliksbilledeItem) {
            // validation for constraint: itemType
            if (!$itSystemerOutputTypeFiltreretOejebliksbilledeItem instanceof \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\FiltreretOejebliksbilledeType) {
                $invalidValues[] = is_object($itSystemerOutputTypeFiltreretOejebliksbilledeItem) ? get_class($itSystemerOutputTypeFiltreretOejebliksbilledeItem) : sprintf('%s(%s)', gettype($itSystemerOutputTypeFiltreretOejebliksbilledeItem), var_export($itSystemerOutputTypeFiltreretOejebliksbilledeItem, true));
            }
        }
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\FiltreretOejebliksbilledeType[] $filtreretOejebliksbillede
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\ItSystemerOutputType
     */
