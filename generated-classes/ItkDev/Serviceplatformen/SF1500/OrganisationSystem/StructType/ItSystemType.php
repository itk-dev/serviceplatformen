...
class ItSystemType extends AktoerType
{
    ...
    public static function validateRegistreringForArrayConstraintFromSetRegistrering(?array $values = []): string
    {
        ...
        foreach ($values as $itSystemTypeRegistreringItem) {
            ...
            if (!$itSystemTypeRegistreringItem instanceof \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\RegistreringType) {
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\RegistreringType[] $registrering
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\ItSystemType
     */
