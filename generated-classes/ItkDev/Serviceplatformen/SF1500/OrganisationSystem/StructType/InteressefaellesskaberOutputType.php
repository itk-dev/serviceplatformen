...
/**
 * This class stands for InteressefaellesskaberOutputType StructType
 * Meta information extracted from the WSDL
 * - definition: urn:oio:sts:interessefaellesskaber:ADD:2.0.0
 * @subpackage Structs
 */
class InteressefaellesskaberOutputType extends AbstractStructBase
{
    /**
     * The FiltreretOejebliksbillede
     * Meta information extracted from the WSDL
     * - content: urn:oio:sagdok:interessefaellesskab:ADD:2.0.0
     * - maxOccurs: unbounded
     * - minOccurs: 0
    ...
    /**
     * Constructor method for InteressefaellesskaberOutputType
     * @uses InteressefaellesskaberOutputType::setFiltreretOejebliksbillede()
    ...
    public static function validateFiltreretOejebliksbilledeForArrayConstraintFromSetFiltreretOejebliksbillede(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $interessefaellesskaberOutputTypeFiltreretOejebliksbilledeItem) {
            // validation for constraint: itemType
            if (!$interessefaellesskaberOutputTypeFiltreretOejebliksbilledeItem instanceof \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\FiltreretOejebliksbilledeType) {
                $invalidValues[] = is_object($interessefaellesskaberOutputTypeFiltreretOejebliksbilledeItem) ? get_class($interessefaellesskaberOutputTypeFiltreretOejebliksbilledeItem) : sprintf('%s(%s)', gettype($interessefaellesskaberOutputTypeFiltreretOejebliksbilledeItem), var_export($interessefaellesskaberOutputTypeFiltreretOejebliksbilledeItem, true));
            }
        }
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\FiltreretOejebliksbilledeType[] $filtreretOejebliksbillede
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\InteressefaellesskaberOutputType
     */
