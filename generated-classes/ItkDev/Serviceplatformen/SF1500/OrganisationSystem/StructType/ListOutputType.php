 ...
 * - definition: urn:oio:sagdok:organisationlistoutput:ADD:2.0.0 | urn:oio:sagdok:organisationenhedlistoutput:ADD:2.0.0 | urn:oio:sagdok:organisationfunktionlistoutput:ADD:2.0.0 | urn:oio:sts:adresselistoutput:ADD:2.0.0 |
 * urn:oio:sts:personlistoutput:ADD:2.0.0 | urn:oio:sagdok:brugerlistoutput:ADD:2.0.0 | urn:oio:sagdok:interessefaellesskablistoutput:ADD:2.0.0 | urn:oio:sagdok:itsystemlistoutput:ADD:2.0.0 | urn:oio:sts:myndighedlistoutput:ADD:2.0.0 |
 * urn:oio:sts:virksomhedlistoutput:ADD:2.0.0 | urn:oio:sagdok:listoutput:ADD:1.0.0
 * @subpackage Structs
 */
class ListOutputType extends BasicOutputType
{
    ...
    public static function validateFiltreretOejebliksbilledeForArrayConstraintFromSetFiltreretOejebliksbillede(?array $values = []): string
    {
        ...
        foreach ($values as $listOutputTypeFiltreretOejebliksbilledeItem) {
            ...
            if (!$listOutputTypeFiltreretOejebliksbilledeItem instanceof \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\FiltreretOejebliksbilledeType) {
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\FiltreretOejebliksbilledeType[] $filtreretOejebliksbillede
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\ListOutputType
     */
