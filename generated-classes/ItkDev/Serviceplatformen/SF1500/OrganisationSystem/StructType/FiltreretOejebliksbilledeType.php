 ...
 * - definition: urn:oio:sagdok:organisationfiltreretoejebliksbillede:ADD:1.0.0 | urn:oio:sagdok:organisationenhedfiltreretoejebliksbillede:ADD:1.0.0 | urn:oio:sagdok:organisationfunktionfiltreretoejebliksbillede:ADD:1.0.0 |
 * urn:oio:sts:sagfiltreretoejebliksbillede:ADD:1.0.0 | urn:oio:sts:personlistoutput:ADD:1.0.0 | urn:oio:sagdok:brugerfiltreretoejebliksbillede:ADD:1.0.0 | urn:oio:sagdok:interessefaellesskabfiltreretoejebliksbillede:ADD:1.0.0 |
 * urn:oio:sagdok:itsystemfiltreretoejebliksbillede:ADD:1.0.0 | urn:oio:sts:myndighedfiltreretoejebliksbillede:ADD:1.0.0
 * @subpackage Structs
 */
class FiltreretOejebliksbilledeType extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - content: objekt
     * @var \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\SagDokObjektType|null
     */
    protected ?\ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\SagDokObjektType $ObjektType = null;
    /**
     * The Registrering
     * Meta information extracted from the WSDL
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\SagDokObjektType $objektType
     * @param \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\RegistreringType[] $registrering
     */
    public function __construct(?\ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\SagDokObjektType $objektType = null, ?array $registrering = null)
    {
        $this
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\SagDokObjektType|null
     */
    public function getObjektType(): ?\ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\SagDokObjektType
    {
     ...
     */
    public function setObjektType(?\ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\SagDokObjektType $objektType = null): self
    {
    ...
    public static function validateRegistreringForArrayConstraintFromSetRegistrering(?array $values = []): string
    {
        ...
        foreach ($values as $filtreretOejebliksbilledeTypeRegistreringItem) {
            ...
            if (!$filtreretOejebliksbilledeTypeRegistreringItem instanceof \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\RegistreringType) {
