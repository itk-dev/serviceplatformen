...
/**
 * This class stands for BrugereOutputType StructType
 * Meta information extracted from the WSDL
 * - definition: urn:oio:sts:brugere:ADD:2.0.0
 * @subpackage Structs
 */
class BrugereOutputType extends AbstractStructBase
{
    /**
     * The FiltreretOejebliksbillede
     * Meta information extracted from the WSDL
     * - content: urn:oio:sagdok:bruger:ADD:2.0.0
     * - maxOccurs: unbounded
     * - minOccurs: 0
    ...
    /**
     * Constructor method for BrugereOutputType
     * @uses BrugereOutputType::setFiltreretOejebliksbillede()
    ...
    public static function validateFiltreretOejebliksbilledeForArrayConstraintFromSetFiltreretOejebliksbillede(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $brugereOutputTypeFiltreretOejebliksbilledeItem) {
            // validation for constraint: itemType
            if (!$brugereOutputTypeFiltreretOejebliksbilledeItem instanceof \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\FiltreretOejebliksbilledeType) {
                $invalidValues[] = is_object($brugereOutputTypeFiltreretOejebliksbilledeItem) ? get_class($brugereOutputTypeFiltreretOejebliksbilledeItem) : sprintf('%s(%s)', gettype($brugereOutputTypeFiltreretOejebliksbilledeItem), var_export($brugereOutputTypeFiltreretOejebliksbilledeItem, true));
            }
        }
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\FiltreretOejebliksbilledeType[] $filtreretOejebliksbillede
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\BrugereOutputType
     */
