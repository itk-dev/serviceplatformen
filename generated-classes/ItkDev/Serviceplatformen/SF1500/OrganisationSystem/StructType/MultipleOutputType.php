...
class MultipleOutputType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\UnikReturType[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\StandardReturType[]
     */
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\UnikReturType[] $unikRetur
    ...
    /**
     * Get UnikRetur value
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\UnikReturType[]|null
     */
    ...
    public static function validateUnikReturForArrayConstraintFromSetUnikRetur(?array $values = []): string
    {
        ...
        foreach ($values as $multipleOutputTypeUnikReturItem) {
            ...
            if (!$multipleOutputTypeUnikReturItem instanceof \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\UnikReturType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The UnikRetur property can only contain items of type \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\UnikReturType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\UnikReturType $item
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\MultipleOutputType
     */
    public function addToUnikRetur(\ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\UnikReturType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\UnikReturType) {
            throw new InvalidArgumentException(sprintf('The UnikRetur property can only contain items of type \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\UnikReturType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: choice(UnikRetur, StandardRetur)
    ...
    public static function validateStandardReturForArrayConstraintFromSetStandardRetur(?array $values = []): string
    {
        ...
        foreach ($values as $multipleOutputTypeStandardReturItem) {
            // validation for constraint: itemType
            if (!$multipleOutputTypeStandardReturItem instanceof \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\StandardReturType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The StandardRetur property can only contain items of type \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\StandardReturType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\StandardReturType $item
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\MultipleOutputType
     */
    public function addToStandardRetur(\ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\StandardReturType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\StandardReturType) {
            throw new InvalidArgumentException(sprintf('The StandardRetur property can only contain items of type \ItkDev\Serviceplatformen\SF1500\OrganisationSystem\StructType\StandardReturType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: choice(UnikRetur, StandardRetur)
