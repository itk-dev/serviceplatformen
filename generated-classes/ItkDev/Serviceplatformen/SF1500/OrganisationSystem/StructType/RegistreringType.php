 ...
 * - definition: urn:oio:sagdok:organisationregistrering:ADD:2.0.0 | urn:oio:sagdok:organisationenhedregistrering:ADD:2.0.0 | urn:oio:sagdok:organisationfunktionregistrering:ADD:2.0.0 | urn:oio:sagdok:adresseregistrering:ADD:2.0.0 |
 * urn:oio:sagdok:personregistrering:ADD:2.0.0 | urn:oio:sagdok:brugerregistrering:ADD:2.0.0 | urn:oio:sagdok:interessefaellesskabregistrering:ADD:2.0.0 | urn:oio:sagdok:itsystemregistrering:ADD:2.0.0 | urn:oio:sagdok:myndighedregistrering:ADD:2.0.0 |
 * urn:oio:sagdok:virksomhedregistrering:ADD:2.0.0 | urn:oio:sagdok:registrering:ADD:2.0.0
 * @subpackage Structs
 */
