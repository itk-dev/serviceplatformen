...
class SoegVirkningType extends AbstractStructBase
{
     ...
     */
    protected ?\ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\UnikIdType $AktoerRef = null;
    /**
     * The AktoerTypeKode
     * Meta information extracted from the WSDL
     * - content: aktoertype
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\UnikIdType $aktoerRef
     * @param string $aktoerTypeKode
     * @param string $noteTekst
     */
    public function __construct(?\ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\TidspunktType $fraTidspunkt = null, ?\ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\TidspunktType $tilTidspunkt = null, ?\ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\UnikIdType $aktoerRef = null, ?string $aktoerTypeKode = null, ?string $noteTekst = null)
    {
        $this
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\TidspunktType $fraTidspunkt
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\SoegVirkningType
     */
     ...
     */
    public function getAktoerRef(): ?\ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\UnikIdType
    {
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\SoegVirkningType
     */
    public function setAktoerRef(?\ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\UnikIdType $aktoerRef = null): self
    {
     ...
     * @uses \ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\EnumType\AktoerTypeKodeType::valueIsValid()
     * @uses \ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\EnumType\AktoerTypeKodeType::getValidValues()
    ...
    public function setAktoerTypeKode(?string $aktoerTypeKode = null): self
    {
        ...
        if (!\ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\EnumType\AktoerTypeKodeType::valueIsValid($aktoerTypeKode)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\EnumType\AktoerTypeKodeType', is_array($aktoerTypeKode) ? implode(', ', $aktoerTypeKode) : var_export($aktoerTypeKode, true), implode(', ', \ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\EnumType\AktoerTypeKodeType::getValidValues())), __LINE__);
        }
