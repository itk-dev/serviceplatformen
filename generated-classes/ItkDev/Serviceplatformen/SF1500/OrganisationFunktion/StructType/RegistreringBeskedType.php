 ...
 * - definition: urn:oio:sagdok:organisationfunktionregistreringbesked:ADD:1.0.0
 * @subpackage Structs
 */
class RegistreringBeskedType extends AbstractStructBase
{
     ...
     * @var \ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\RegistreringType|null
     */
    protected ?\ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\RegistreringType $Registrering = null;
    /**
     ...
     */
    public function __construct(?string $uUIDIdentifikator = null, ?\ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\RegistreringType $registrering = null)
    {
        $this
     ...
     * @param string $uUIDIdentifikator
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\RegistreringBeskedType
     */
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\RegistreringType|null
     */
    public function getRegistrering(): ?\ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\RegistreringType
    {
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\RegistreringBeskedType
     */
    public function setRegistrering(?\ItkDev\Serviceplatformen\SF1500\OrganisationFunktion\StructType\RegistreringType $registrering = null): self
    {
