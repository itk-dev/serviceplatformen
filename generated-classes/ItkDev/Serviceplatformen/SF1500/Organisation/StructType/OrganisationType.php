...
class OrganisationType extends AktoerType
{
    ...
    public static function validateRegistreringForArrayConstraintFromSetRegistrering(?array $values = []): string
    {
        ...
        foreach ($values as $organisationTypeRegistreringItem) {
            ...
            if (!$organisationTypeRegistreringItem instanceof \ItkDev\Serviceplatformen\SF1500\Organisation\StructType\RegistreringType) {
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\Organisation\StructType\RegistreringType[] $registrering
     * @return \ItkDev\Serviceplatformen\SF1500\Organisation\StructType\OrganisationType
     */
