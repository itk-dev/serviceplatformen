...
/**
 * This class stands for JournalPostFlerRelationType StructType
 * Meta information extracted from the WSDL
 * - definition: urn:oio:sagdok:journalpostflerrelation:ADD:1.0.0
 * @subpackage Structs
 */
class JournalPostFlerRelationType extends NulFlerRelationType
{
     ...
     * @var \ItkDev\Serviceplatformen\SF1500\OrganisationAdministration\StructType\OffentlighedUndtagetType|null
     */
    protected ?\ItkDev\Serviceplatformen\SF1500\OrganisationAdministration\StructType\OffentlighedUndtagetType $OffentlighedUndtaget = null;
    /**
    ...
    /**
     * Constructor method for JournalPostFlerRelationType
     * @uses JournalPostFlerRelationType::setJournalPostIdentifikator()
     * @uses JournalPostFlerRelationType::setTitelTekst()
     * @uses JournalPostFlerRelationType::setIndeksIdentifikator()
     * @uses JournalPostFlerRelationType::setOffentlighedUndtaget()
     * @uses JournalPostFlerRelationType::setTilhoersforholdKode()
     * @param string $journalPostIdentifikator
     * @param string $titelTekst
     * @param int $indeksIdentifikator
     * @param \ItkDev\Serviceplatformen\SF1500\OrganisationAdministration\StructType\OffentlighedUndtagetType $offentlighedUndtaget
     * @param string $tilhoersforholdKode
     */
    public function __construct(?string $journalPostIdentifikator = null, ?string $titelTekst = null, ?int $indeksIdentifikator = null, ?\ItkDev\Serviceplatformen\SF1500\OrganisationAdministration\StructType\OffentlighedUndtagetType $offentlighedUndtaget = null, ?string $tilhoersforholdKode = null)
    {
        $this
     ...
     * @param string $journalPostIdentifikator
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationAdministration\StructType\JournalPostFlerRelationType
     */
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationAdministration\StructType\OffentlighedUndtagetType|null
     */
    public function getOffentlighedUndtaget(): ?\ItkDev\Serviceplatformen\SF1500\OrganisationAdministration\StructType\OffentlighedUndtagetType
    {
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\OrganisationAdministration\StructType\JournalPostFlerRelationType
     */
    public function setOffentlighedUndtaget(?\ItkDev\Serviceplatformen\SF1500\OrganisationAdministration\StructType\OffentlighedUndtagetType $offentlighedUndtaget = null): self
    {
     ...
     * @uses \ItkDev\Serviceplatformen\SF1500\OrganisationAdministration\EnumType\TilhoersforholdKodeType::valueIsValid()
     * @uses \ItkDev\Serviceplatformen\SF1500\OrganisationAdministration\EnumType\TilhoersforholdKodeType::getValidValues()
    ...
    public function setTilhoersforholdKode(?string $tilhoersforholdKode = null): self
    {
        ...
        if (!\ItkDev\Serviceplatformen\SF1500\OrganisationAdministration\EnumType\TilhoersforholdKodeType::valueIsValid($tilhoersforholdKode)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \ItkDev\Serviceplatformen\SF1500\OrganisationAdministration\EnumType\TilhoersforholdKodeType', is_array($tilhoersforholdKode) ? implode(', ', $tilhoersforholdKode) : var_export($tilhoersforholdKode, true), implode(', ', \ItkDev\Serviceplatformen\SF1500\OrganisationAdministration\EnumType\TilhoersforholdKodeType::getValidValues())), __LINE__);
        }
