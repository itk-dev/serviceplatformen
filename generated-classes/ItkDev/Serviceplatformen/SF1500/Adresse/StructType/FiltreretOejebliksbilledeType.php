...
class FiltreretOejebliksbilledeType extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - content: objekt
     * @var \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\SagDokObjektType|null
     */
    protected ?\ItkDev\Serviceplatformen\SF1500\Adresse\StructType\SagDokObjektType $ObjektType = null;
    /**
     * The Registrering
     * Meta information extracted from the WSDL
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\SagDokObjektType $objektType
     * @param \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\RegistreringType[] $registrering
     */
    public function __construct(?\ItkDev\Serviceplatformen\SF1500\Adresse\StructType\SagDokObjektType $objektType = null, ?array $registrering = null)
    {
        $this
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\SagDokObjektType|null
     */
    public function getObjektType(): ?\ItkDev\Serviceplatformen\SF1500\Adresse\StructType\SagDokObjektType
    {
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\SagDokObjektType $objektType
     * @return \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\FiltreretOejebliksbilledeType
     */
    public function setObjektType(?\ItkDev\Serviceplatformen\SF1500\Adresse\StructType\SagDokObjektType $objektType = null): self
    {
    ...
    public static function validateRegistreringForArrayConstraintFromSetRegistrering(?array $values = []): string
    {
        ...
        foreach ($values as $filtreretOejebliksbilledeTypeRegistreringItem) {
            ...
            if (!$filtreretOejebliksbilledeTypeRegistreringItem instanceof \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\RegistreringType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Registrering property can only contain items of type \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\RegistreringType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\RegistreringType $item
     * @return \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\FiltreretOejebliksbilledeType
     */
    public function addToRegistrering(\ItkDev\Serviceplatformen\SF1500\Adresse\StructType\RegistreringType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\RegistreringType) {
            throw new InvalidArgumentException(sprintf('The Registrering property can only contain items of type \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\RegistreringType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
