...
class AdresseType extends SagDokObjektType
{
    ...
    public static function validateRegistreringForArrayConstraintFromSetRegistrering(?array $values = []): string
    {
        ...
        foreach ($values as $adresseTypeRegistreringItem) {
            ...
            if (!$adresseTypeRegistreringItem instanceof \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\RegistreringType) {
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\RegistreringType[] $registrering
     * @return \ItkDev\Serviceplatformen\SF1500\Adresse\StructType\AdresseType
     */
