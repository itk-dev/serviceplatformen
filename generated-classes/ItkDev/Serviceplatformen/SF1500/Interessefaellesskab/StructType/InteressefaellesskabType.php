...
class InteressefaellesskabType extends AktoerType
{
    ...
    public static function validateRegistreringForArrayConstraintFromSetRegistrering(?array $values = []): string
    {
        ...
        foreach ($values as $interessefaellesskabTypeRegistreringItem) {
            ...
            if (!$interessefaellesskabTypeRegistreringItem instanceof \ItkDev\Serviceplatformen\SF1500\Interessefaellesskab\StructType\RegistreringType) {
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\Interessefaellesskab\StructType\RegistreringType[] $registrering
     * @return \ItkDev\Serviceplatformen\SF1500\Interessefaellesskab\StructType\InteressefaellesskabType
     */
