 ...
 * - definition: urn:oio:sagdok:facetopretinput:ADD:2.0.0 | urn:oio:sagdok:opretinput:ADD:1.0.0
 * @subpackage Structs
 */
class OpretInputType extends AbstractStructBase
{
     ...
     * Set NoteTekst value
     * @param string $noteTekst
     * @return \ItkDev\Serviceplatformen\SF1500\Facet\StructType\OpretInputType
     */
