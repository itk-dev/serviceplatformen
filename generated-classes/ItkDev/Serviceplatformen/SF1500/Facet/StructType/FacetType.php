...
class FacetType extends SagDokObjektType
{
    ...
    public static function validateRegistreringForArrayConstraintFromSetRegistrering(?array $values = []): string
    {
        ...
        foreach ($values as $facetTypeRegistreringItem) {
            ...
            if (!$facetTypeRegistreringItem instanceof \ItkDev\Serviceplatformen\SF1500\Facet\StructType\RegistreringType) {
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\Facet\StructType\RegistreringType[] $registrering
     * @return \ItkDev\Serviceplatformen\SF1500\Facet\StructType\FacetType
     */
