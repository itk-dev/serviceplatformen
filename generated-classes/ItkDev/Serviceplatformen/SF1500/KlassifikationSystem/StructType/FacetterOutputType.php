...
/**
 * This class stands for FacetterOutputType StructType
 * Meta information extracted from the WSDL
 * - definition: urn:oio:sts:facetter:ADD:2.0.0
 * @subpackage Structs
 */
class FacetterOutputType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for FacetterOutputType
     * @uses FacetterOutputType::setFiltreretOejebliksbillede()
    ...
    public static function validateFiltreretOejebliksbilledeForArrayConstraintFromSetFiltreretOejebliksbillede(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $facetterOutputTypeFiltreretOejebliksbilledeItem) {
            // validation for constraint: itemType
            if (!$facetterOutputTypeFiltreretOejebliksbilledeItem instanceof \ItkDev\Serviceplatformen\SF1500\KlassifikationSystem\StructType\FiltreretOejebliksbilledeType) {
                $invalidValues[] = is_object($facetterOutputTypeFiltreretOejebliksbilledeItem) ? get_class($facetterOutputTypeFiltreretOejebliksbilledeItem) : sprintf('%s(%s)', gettype($facetterOutputTypeFiltreretOejebliksbilledeItem), var_export($facetterOutputTypeFiltreretOejebliksbilledeItem, true));
            }
        }
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\KlassifikationSystem\StructType\FiltreretOejebliksbilledeType[] $filtreretOejebliksbillede
     * @return \ItkDev\Serviceplatformen\SF1500\KlassifikationSystem\StructType\FacetterOutputType
     */
