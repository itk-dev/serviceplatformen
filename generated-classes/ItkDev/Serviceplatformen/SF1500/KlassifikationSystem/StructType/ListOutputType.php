 ...
 * - definition: urn:oio:sagdok:facetlistoutput:ADD:2.0.0 | urn:oio:sagdok:klasselistoutput:ADD:2.0.0 | urn:oio:sagdok:klassifikationlistoutput:ADD:2.0.0 | urn:oio:sagdok:listoutput:ADD:1.0.0
 * @subpackage Structs
 */
class ListOutputType extends AbstractStructBase
{
     ...
     */
    public function __construct(?\ItkDev\Serviceplatformen\SF1500\KlassifikationSystem\StructType\StandardReturType $standardRetur = null, ?array $filtreretOejebliksbillede = null)
    {
        $this
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\KlassifikationSystem\StructType\StandardReturType $standardRetur
     * @return \ItkDev\Serviceplatformen\SF1500\KlassifikationSystem\StructType\ListOutputType
     */
    ...
    public static function validateFiltreretOejebliksbilledeForArrayConstraintFromSetFiltreretOejebliksbillede(?array $values = []): string
    {
        ...
        foreach ($values as $listOutputTypeFiltreretOejebliksbilledeItem) {
            ...
            if (!$listOutputTypeFiltreretOejebliksbilledeItem instanceof \ItkDev\Serviceplatformen\SF1500\KlassifikationSystem\StructType\FiltreretOejebliksbilledeType) {
