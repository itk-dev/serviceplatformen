...
/**
 * This class stands for KlasserOutputType StructType
 * Meta information extracted from the WSDL
 * - definition: urn:oio:sts:klasser:ADD:2.0.0
 * @subpackage Structs
 */
class KlasserOutputType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for KlasserOutputType
     * @uses KlasserOutputType::setFiltreretOejebliksbillede()
    ...
    public static function validateFiltreretOejebliksbilledeForArrayConstraintFromSetFiltreretOejebliksbillede(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $klasserOutputTypeFiltreretOejebliksbilledeItem) {
            // validation for constraint: itemType
            if (!$klasserOutputTypeFiltreretOejebliksbilledeItem instanceof \ItkDev\Serviceplatformen\SF1500\KlassifikationSystem\StructType\FiltreretOejebliksbilledeType) {
                $invalidValues[] = is_object($klasserOutputTypeFiltreretOejebliksbilledeItem) ? get_class($klasserOutputTypeFiltreretOejebliksbilledeItem) : sprintf('%s(%s)', gettype($klasserOutputTypeFiltreretOejebliksbilledeItem), var_export($klasserOutputTypeFiltreretOejebliksbilledeItem, true));
            }
        }
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\KlassifikationSystem\StructType\FiltreretOejebliksbilledeType[] $filtreretOejebliksbillede
     * @return \ItkDev\Serviceplatformen\SF1500\KlassifikationSystem\StructType\KlasserOutputType
     */
