 ...
 * - definition: urn:oio:sagdok:klassepubliceret:ADD:2.0.0
 * @subpackage Structs
 */
class PubliceretStatusType extends AbstractStructBase
{
     ...
     */
    public function __construct(?\ItkDev\Serviceplatformen\SF1500\Klasse\StructType\VirkningType $virkning = null, ?bool $erPubliceretIndikator = null)
    {
        $this
