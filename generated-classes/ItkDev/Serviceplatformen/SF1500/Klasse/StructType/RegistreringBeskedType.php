 ...
 * - definition: urn:oio:sagdok:klasseregistreringbesked:ADD:1.0.0
 * @subpackage Structs
 */
class RegistreringBeskedType extends AbstractStructBase
{
     ...
     * @var \ItkDev\Serviceplatformen\SF1500\Klasse\StructType\RegistreringType|null
     */
    protected ?\ItkDev\Serviceplatformen\SF1500\Klasse\StructType\RegistreringType $Registrering = null;
    /**
     ...
     */
    public function __construct(?string $uUIDIdentifikator = null, ?\ItkDev\Serviceplatformen\SF1500\Klasse\StructType\RegistreringType $registrering = null)
    {
        $this
     ...
     * @param string $uUIDIdentifikator
     * @return \ItkDev\Serviceplatformen\SF1500\Klasse\StructType\RegistreringBeskedType
     */
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\Klasse\StructType\RegistreringType|null
     */
    public function getRegistrering(): ?\ItkDev\Serviceplatformen\SF1500\Klasse\StructType\RegistreringType
    {
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\Klasse\StructType\RegistreringBeskedType
     */
    public function setRegistrering(?\ItkDev\Serviceplatformen\SF1500\Klasse\StructType\RegistreringType $registrering = null): self
    {
