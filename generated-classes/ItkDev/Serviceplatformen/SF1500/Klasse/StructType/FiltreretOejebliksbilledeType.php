 ...
 * - definition: urn:oio:sagdok:klassefiltreretoejebliksbillede:ADD:1.0.0
 * @subpackage Structs
 */
class FiltreretOejebliksbilledeType extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - content: objekt
     * @var \ItkDev\Serviceplatformen\SF1500\Klasse\StructType\SagDokObjektType|null
     */
    protected ?\ItkDev\Serviceplatformen\SF1500\Klasse\StructType\SagDokObjektType $ObjektType = null;
    /**
     * The Registrering
     * Meta information extracted from the WSDL
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\Klasse\StructType\SagDokObjektType $objektType
     * @param \ItkDev\Serviceplatformen\SF1500\Klasse\StructType\RegistreringType[] $registrering
     */
    public function __construct(?\ItkDev\Serviceplatformen\SF1500\Klasse\StructType\SagDokObjektType $objektType = null, ?array $registrering = null)
    {
        $this
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\Klasse\StructType\SagDokObjektType|null
     */
    public function getObjektType(): ?\ItkDev\Serviceplatformen\SF1500\Klasse\StructType\SagDokObjektType
    {
     ...
     */
    public function setObjektType(?\ItkDev\Serviceplatformen\SF1500\Klasse\StructType\SagDokObjektType $objektType = null): self
    {
    ...
    public static function validateRegistreringForArrayConstraintFromSetRegistrering(?array $values = []): string
    {
        ...
        foreach ($values as $filtreretOejebliksbilledeTypeRegistreringItem) {
            ...
            if (!$filtreretOejebliksbilledeTypeRegistreringItem instanceof \ItkDev\Serviceplatformen\SF1500\Klasse\StructType\RegistreringType) {
