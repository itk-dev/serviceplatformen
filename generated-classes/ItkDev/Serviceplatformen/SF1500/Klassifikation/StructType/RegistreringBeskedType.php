 ...
 * - definition: urn:oio:sagdok:klassifikationregistreringbesked:ADD:1.0.0
 * @subpackage Structs
 */
class RegistreringBeskedType extends AbstractStructBase
{
     ...
     * - ref: klasfik:Registrering
     * @var \ItkDev\Serviceplatformen\SF1500\Klassifikation\StructType\RegistreringType|null
     */
    protected ?\ItkDev\Serviceplatformen\SF1500\Klassifikation\StructType\RegistreringType $Registrering = null;
    /**
     ...
     */
    public function __construct(?string $uUIDIdentifikator = null, ?\ItkDev\Serviceplatformen\SF1500\Klassifikation\StructType\RegistreringType $registrering = null)
    {
        $this
     ...
     * @param string $uUIDIdentifikator
     * @return \ItkDev\Serviceplatformen\SF1500\Klassifikation\StructType\RegistreringBeskedType
     */
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\Klassifikation\StructType\RegistreringType|null
     */
    public function getRegistrering(): ?\ItkDev\Serviceplatformen\SF1500\Klassifikation\StructType\RegistreringType
    {
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\Klassifikation\StructType\RegistreringBeskedType
     */
    public function setRegistrering(?\ItkDev\Serviceplatformen\SF1500\Klassifikation\StructType\RegistreringType $registrering = null): self
    {
