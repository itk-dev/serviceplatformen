 ...
 * - definition: urn:oio:sts:myndighedretinput:ADD:2.0.0 | urn:oio:sagdok:retinput:ADD:1.0.0
 * @subpackage Structs
 */
class RetInputType extends AbstractStructBase
{
     ...
     * @param string $uUIDIdentifikator
     * @return \ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\RetInputType
     */
