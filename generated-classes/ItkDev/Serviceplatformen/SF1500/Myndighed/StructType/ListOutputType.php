 ...
 * - definition: urn:oio:sts:myndighedlistoutput:ADD:2.0.0 | urn:oio:sagdok:listoutput:ADD:1.0.0
 * @subpackage Structs
 */
class ListOutputType extends AbstractStructBase
{
     ...
     * @var \ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\StandardReturType|null
     */
    protected ?\ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\StandardReturType $StandardRetur = null;
    /**
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\FiltreretOejebliksbilledeType[]
     */
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\FiltreretOejebliksbilledeType[] $filtreretOejebliksbillede
     */
    public function __construct(?\ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\StandardReturType $standardRetur = null, ?array $filtreretOejebliksbillede = null)
    {
        $this
     ...
     */
    public function getStandardRetur(): ?\ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\StandardReturType
    {
     ...
     * @param \ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\StandardReturType $standardRetur
     * @return \ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\ListOutputType
     */
    public function setStandardRetur(?\ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\StandardReturType $standardRetur = null): self
    {
     ...
     * @return \ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\FiltreretOejebliksbilledeType[]
     */
    ...
    public static function validateFiltreretOejebliksbilledeForArrayConstraintFromSetFiltreretOejebliksbillede(?array $values = []): string
    {
        ...
        foreach ($values as $listOutputTypeFiltreretOejebliksbilledeItem) {
            ...
            if (!$listOutputTypeFiltreretOejebliksbilledeItem instanceof \ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\FiltreretOejebliksbilledeType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The FiltreretOejebliksbillede property can only contain items of type \ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\FiltreretOejebliksbilledeType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\FiltreretOejebliksbilledeType $item
     * @return \ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\ListOutputType
     */
    public function addToFiltreretOejebliksbillede(\ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\FiltreretOejebliksbilledeType $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\FiltreretOejebliksbilledeType) {
            throw new InvalidArgumentException(sprintf('The FiltreretOejebliksbillede property can only contain items of type \ItkDev\Serviceplatformen\SF1500\Myndighed\StructType\FiltreretOejebliksbilledeType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
