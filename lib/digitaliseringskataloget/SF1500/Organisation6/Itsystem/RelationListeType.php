...
class RelationListeType
{
    ...
    /**
     * @var \Digitaliseringskataloget\Sagdok3_0_0\SystemTyper[] $systemTyper
     */
    private $systemTyper = [
     ...
     *
     * @return self
     * @param \Digitaliseringskataloget\Sagdok3_0_0\SystemTyper $systemTyper
     */
    public function addToSystemTyper(\Digitaliseringskataloget\Sagdok3_0_0\SystemTyper $systemTyper)
    {
     ...
     * @return bool
     */
    public function issetSystemTyper($index)
    {
        return isset($this->systemTyper[$index]);
    }
     ...
     * @return void
     */
    public function unsetSystemTyper($index)
    {
        unset($this->systemTyper[$index]);
    }

    /**
     * Gets as systemTyper
     *
     * @return \Digitaliseringskataloget\Sagdok3_0_0\SystemTyper[]
     */
    public function getSystemTyper()
    {
        return $this->systemTyper;
    }

    /**
     * Sets a new systemTyper
     *
     * @param \Digitaliseringskataloget\Sagdok3_0_0\SystemTyper[] $systemTyper
     * @return self
     */
    public function setSystemTyper(array $systemTyper = null)
    {
        $this->systemTyper = $systemTyper;
        return $this;
    }
     ...
     */
    public function addToTilhoerer(\Digitaliseringskataloget\Sagdok3_0_0\Tilhoerer $tilhoerer)
    {
     ...
     * @return bool
     */
    public function issetTilhoerer($index)
    {
        return isset($this->tilhoerer[$index]);
    }
     ...
     * @return void
     */
    public function unsetTilhoerer($index)
    {
        unset($this->tilhoerer[$index]);
    }
     ...
     * @return self
     */
    public function setTilhoerer(array $tilhoerer = null)
    {
        $this->tilhoerer = $tilhoerer;
        return $this;
    }
