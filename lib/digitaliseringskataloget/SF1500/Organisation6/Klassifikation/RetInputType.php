...
class RetInputType extends RetInputTypeBase
{
     ...
     * @return self
     */
    public function setTilstandListe(array $tilstandListe = null)
    {
     ...
     * @return self
     */
    public function setRelationListe(?\Digitaliseringskataloget\SF1500\Organisation6\Klassifikation\RelationListe $relationListe = null)
    {
