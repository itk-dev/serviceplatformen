...
class RetInputType extends RetInputTypeBase
{
     ...
     * @return self
     */
    public function setAttributListe(?\Digitaliseringskataloget\SF1500\Organisation6\Organisation\AttributListe $attributListe = null)
    {
     ...
     * @return self
     */
    public function setTilstandListe(?\Digitaliseringskataloget\SF1500\Organisation6\Organisation\TilstandListe $tilstandListe = null)
    {
     ...
     * @return self
     */
    public function setRelationListe(?\Digitaliseringskataloget\SF1500\Organisation6\Organisation\RelationListe $relationListe = null)
    {
